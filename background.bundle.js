...
function buildAgentSystemPrompt(allowScript, hasMCP) {
  return [
    ...
    allowScript ? "4. append_script \u53EF\u7528\uFF0C\u4F46\u4EC5\u5728\u5FC5\u8981\u65F6\u4F7F\u7528\u3002" : "4. append_script \u7981\u7528\uFF0C\u4E0D\u8981\u8C03\u7528\u3002",
    hasMCP ? "5. \u5141\u8BB8\u8C03\u7528 mcp_* \u5DE5\u5177\u8865\u5145\u80FD\u529B\u3002" : "5. \u5F53\u524D\u65E0 MCP \u5DE5\u5177\u3002",
    "\u6700\u540E\u7528\u4E2D\u6587\u56DE\u590D\uFF0C\u8BF4\u660E\u6267\u884C\u6B65\u9AA4\u548C\u7ED3\u679C\u3002"
  ].join("\n");
}
...
function buildMCPHeaders(service) {
...
async function callStreamableHTTP(service, method, params) {
  ...
  if (!resp.ok) {
    throw new Error(data?.error?.message || `Streamable HTTP ${resp.status} (${endpoint})`);
  }
